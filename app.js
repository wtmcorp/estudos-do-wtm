    ...
    if (typeof luckysheet !== 'undefined' && !luckysheetInitialized) {
        luckysheet.create({
            ...
            data: [{
                ...
                "order": "0",
                "data": [
                    [{v:"--- PRODUTOS (Matriz) ---",m:"--- PRODUTOS (Matriz) ---"}],
                    [{v:"CÓDIGO",m:"CÓDIGO"},{v:"NOME",m:"NOME"},{v:"PREÇO",m:"PREÇO"}],
                    [{v:"1001",m:"1001"},{v:"Cadeira Plus",m:"Cadeira Plus"},{v:"850.00",m:"850.00"}],
                    [{v:"1002",m:"1002"},{v:"Mesa Office",m:"Mesa Office"},{v:"1200.00",m:"1200.00"}],
                    [{v:"1003",m:"1003"},{v:"Luminária",m:"Luminária"},{v:"150.00",m:"150.00"}],
                    [{v:"",m:""},{v:"",m:""},{v:"",m:""}],
                    [{v:"--- EXERCÍCIO PRÁTICO ---",m:"--- EXERCÍCIO PRÁTICO ---"}],
                    [{v:"CÓD. BUSCADO:",m:"CÓD. BUSCADO:"},{v:"1002",m:"1002"}],
                    [{v:"QUAL O PREÇO?",m:"QUAL O PREÇO?"},{v:"",m:""}],
                    [{v:"",m:""},{v:"",m:""}],
                    [{v:"💡 Missão:",m:"💡 Missão:"}],
                    [{v:"1. Vá na célula B9 (ao lado de 'QUAL O PREÇO?').",m:"1. Vá na célula B9 (ao lado de 'QUAL O PREÇO?')."}],
                    [{v:"2. Escreva a fórmula de busca para achar o preço do cód 1002.",m:"2. Escreva a fórmula de busca para achar o preço do cód 1002."}],
                    [{v:"3. Por estar no console Web, use =VLOOKUP e (,)",m:"3. Por estar no console Web, use =VLOOKUP e (,)"}],
                    [{v:"   Fórmula real: =VLOOKUP(B8, A2:C5, 3, 0)",m:"   Fórmula real: =VLOOKUP(B8, A2:C5, 3, 0)"}]
                ],
                "config": {},
                "index": 0
            }]
